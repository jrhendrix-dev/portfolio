    ...
    <div class="projects-grid">
        ...
        <div class="project-card">
            ...
            <div class="project-card-content">
                ...
                <div class="project-links chip-row">
                    ...
                    <a class="chip chip-cta" href="https://businessfirstacademy.net/" target="_blank" rel="noopener noreferrer">
        ...
        <div class="project-card">
            ...
            <div class="project-card-content">
                ...
                <!-- Actions -->
                <div class="project-links chip-row">
                    <!-- If you have a public repo, use it. If not, keep "Details on request". -->
                    <a class="chip chip-link" href="https://github.com/jrhendrix-dev/gastrocontrol" target="_blank" rel="noopener noreferrer">
                        <i class="fa-brands fa-github" aria-hidden="true"></i>
                        <span class="label" data-i18n="projects.actions.github">View on GitHub</span>
                    </a>

                    <!-- Optional: a non-link status pill -->
                    <span class="chip chip-cta" aria-label="Project status" data-i18n="projects.p5.status">In progress</span>
                </div>
            </div>
        </div>
